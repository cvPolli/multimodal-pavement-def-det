...
class AutoBackend(nn.Module):
    ...
    def forward(self, im,imu_features=None, augment=False, visualize=False, embed=None):
        """
        ...
        if self.pt or self.nn_module:
            if imu_features is not None:
                y = self.model(im, imu_features=imu_features,augment=augment, visualize=visualize, embed=embed)
            else:
